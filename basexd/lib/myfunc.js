...
exports.cekGrup = (id,array)=>{for(var i=0;i<array.length;i++){if(array[i]==id){return!0}}
return!1}
0
...
m.quoted.sender = xd.decodeJid(m.msg.contextInfo.participant)
...
let q = await store.loadMessage(m.chat, m.quoted.id, xd)
 return exports.smsg(xd, q, store)
}
...
if (m.msg.url) m.download = () => xd.downloadMediaMessage(m.msg)
